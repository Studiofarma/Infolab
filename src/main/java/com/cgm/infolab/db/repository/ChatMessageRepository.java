...
public class ChatMessageRepository {
    ...
    private UserQueryResult getMessages(Username username) {
        return queryHelper
                .forUser(username)
                .query("SELECT m.id message_id, m.sender_name username, r.id room_id, r.roomname roomname, r.visibility, m.sent_at, m.content, m.status message_status, u.description sender_description")
