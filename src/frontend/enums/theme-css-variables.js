...
export const ThemeCSSVariables = {
  ...
  avatarBg0: css`var(--avatarBg0)`,
  avatarBg1: css`var(--avatarBg1)`,
  avatarBg2: css`var(--avatarBg2)`,
  avatarBg3: css`var(--avatarBg3)`,
  avatarBg4: css`var(--avatarBg4)`,
  avatarBg5: css`var(--avatarBg5)`,
  avatarBg6: css`var(--avatarBg6)`,
  avatarBg7: css`var(--avatarBg7)`,
  ...
  timestampMessageTextSender: css`var(--timestampMessageText)`,
  timestampMessageTextReceiver: css`var(--timestampMessageTextReceiver)`,
